...
TEST(trapezoid, d1_test_omp) {
    ...
    double method_result = trapezoid_method(f1, bounds, dimensions, 200, true);
...
TEST(trapezoid, d2_test_omp) {
    ...
    double method_result = trapezoid_method(f2, bounds, dimensions, 510, true);
    double tolerance = 0.005;
...
TEST(trapezoid, d3_test_1_omp) {
    ...
    double method_result = trapezoid_method(f3, bounds, dimensions, 510, true);
...
TEST(trapezoid, d3_test_2_omp) {
    ...
    double method_result = trapezoid_method(f4, bounds, dimensions, 540, true);
    double tolerance = 0.05;
